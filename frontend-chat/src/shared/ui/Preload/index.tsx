...
export function Preload({ title, className, image, load = false }: IProps) {
  ...
  return (
    <>
     ...
     {image ? <img className="mt-auto mb-3 cursor-default h-[250px] w-[280px] 3xl:h-[338] 3xl:w-[370px]" src={image} alt=""/> :  !load ? <PrintIcon className="mt-auto cursor-default h-[250px] w-[280px] 3xl:h-[338] 3xl:w-[370px]"/> : <img
